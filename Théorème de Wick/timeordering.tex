...
+\mathcal{T}\{\phi(x_1)\phi(x_3)\}\mathcal{T}\{\phi(x_2)\phi(x_4)\}\\
&+\mathcal{T}\{\phi(x_1)\phi(x_4)\}\mathcal{T}\{\phi(x_2)\phi(x_3)\}
\end{split}
 \end{equation*}
...
\begin{equation}
\mathcal{T}\{\phi_{x}\phi_{y}\}= \Delta_{F}(x-y)\mathds{1}+
\Theta(x^{0}-y^{0})N\{\phi_{x}\phi_{y}\}+
\Theta(y^{0}-x^{0})N\{\phi_{y}\phi_{x}\}
\end{equation}
